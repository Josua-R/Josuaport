...
GALLERY_ROOT = "./portfolio"
OUTPUT_FILE = "portfolioList.js"
...
def scan_gallery(root):
    ...
    for category in sorted(os.listdir(root)):
        ...
        source_files = [
            ...
            and not name.lower().endswith(".thumb.png")
        ]
        source_files.sort(
            key=lambda name: (
        ...
        for file_name in source_files:
            ...
            mp4_name = lower_names.get(f"{stem_key}.mp4")
            thumb_name = lower_names.get(f"{stem_key}.thumb.png")
            preferred_full = mp4_name or file_name
            ...
            gallery_items.append(
                {
                    ...
                    "type": (
                        "video"
                        if preferred_full.lower().endswith(".mp4")
                        else "image"
                    ),
                }
            )
